...
def get_color_bar(figsize=(8, 3), cmap=None, ticklabels=['Negative', 0,'Positive'],
                  result_path=None, label='SHAP values', font_size = 20):

    from matplotlib.font_manager import fontManager, FontProperties

    path = "./ttf/WorkSans-Regular.ttf"
    ...
    if cmap is None:
        cmap = mpl.colors.LinearSegmentedColormap.from_list('my_colormap', lamarr,)

    cb1 = mpl.colorbar.ColorbarBase(ax, cmap=cmap,
                                    # ticks=[0, 0.5, 1],
                                    orientation='horizontal')
    cb1.set_label(label, fontsize=font_size, font=path)
    cb1.set_ticks([0, 0.5, 1])
    cb1.set_ticklabels(ticklabels, fontsize=font_size, font=path)
